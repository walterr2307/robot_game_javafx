...
public class MovimentoInvalidoException extends Exception {
    ...
    public void mostrarMensagem(Pane root, ImageView img_robo, ImageView img_comida, Rectangle[][] blocos, int largura)
        ...
        mov_invalido.setLayoutX(largura * 0.15);
